...
cd /root/stratux
git checkout v1.6r1-eu032 # Latest EU032 release from https://github.com/stratux/stratux/releases/tag/v1.6r1-eu032
...
# Replace goflying with lordvampire fork (WITH MAGNETOMETER SUPPORT!)
/root/go/bin/go mod edit -replace github.com/b3nn0/goflying=github.com/lordvampire/goflying@master

# Get the new version
echo "Downloading lordvampire/goflying with magnetometer support..."
/root/go/bin/go get github.com/lordvampire/goflying@master
