...
const (
	...
	BITS_FS_1000DPS = 0x06 // GYRO_CONFIG - MATCH PYTHON! (was 0x04, but Python uses 0x06 and it works)
	...
	BIT_I2C_MST_P_NSR      uint8 = 0x10  // I2C_MST_CTRL: Stop between reads (Bit 4)
